...
import RadiusIcon from "../../assets/icons/RadiusIcon.tsx"
...
import { Radius } from "../../stores/OperationStores/RadiusStore.tsx"
...
export const RadiusDialog = observer(() => {
    ...
    return(
        <React.Fragment>
        <Button sx={{height: 60,width: 60, backgroundColor:"#2D2D2D"} } onClick={handleClickRadius}><RadiusIcon></RadiusIcon></Button>
        <Modal open={open} onClose={handleClickRadius}>
                    <Box sx={style}>
                        <Grid2 container columnSpacing={{ xs: 1, sm: 2, md: 3 }}  rowGap={1}>
                            ...
                            var radius = new Radius(parseFloat(text_one), alignment);
                            selectedPart?.opStore.corners.addOperation(radius, alignment)
                            handleClickRadius()
